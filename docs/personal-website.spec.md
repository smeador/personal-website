...
│   └── austin-skyline.png
└── docs/
    ├── resume-sean-meador.pdf   # Generated by scripts/generate-resume.py
    └── project-interactive-relighting.pdf
scripts/
└── generate-resume.py           # Source of truth for the resume PDF
```
...
pip install reportlab && python scripts/generate-resume.py   # Regenerate resume PDF
```
...
7. Resume downloads correctly from `/docs/resume-sean-meador.pdf`
